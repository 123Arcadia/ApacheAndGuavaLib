...
public class NumberUtilsTest {
     ...
     */
    @Test
    public void createBigIntegerTest() {
        ...
        // java.lang.NumberFormatException: For input string: "3.14159"
        // System.out.println(NumberUtils.createBigInteger("3.14159"));
    }

    /**
     * BigDecimal createBigDecimal(final String str)
     * 1、将字符串转成 BigDecimal，只支持 10 进制，底层就是使用 new BigDecimal(str)
     * 2、str 为null时，返回 null
     * 3、str 为空时报错 java.lang.NumberFormatException: A blank string is not a valid number
     * 4、不支持类型限定符（110L、3.14F）
     * 5、支持 科学计数法（8.888888888888889E13）
     */
    @Test
    public void createBigDecimalTest() {
        ...
        // 支持 科学计数法
        // 878800.6
        System.out.println(NumberUtils.createBigDecimal("8.788006e+05"));
        // 88888888888888.89
        System.out.println(NumberUtils.createBigDecimal("8.888888888888889E13").toString());
        ...
        // System.out.println(NumberUtils.createBigDecimal("x"));

        // 只支持10进制，java.lang.NumberFormatException
        // System.out.println(NumberUtils.createBigDecimal("0X1F40"));

        // java.lang.NumberFormatException
        // System.out.println(NumberUtils.createBigDecimal("888.22F"));
    }
    ...
    public void isParsableTest() {
        ...
        dataMap.put("salary_d", 1988876565677.99889);
        dataMap.put("salary_s", "1988876565677.99889");

        // 1.9888765656779988E12 -> 1.9888765656779988E12 -> false
        System.out.println(dataMap.get("salary_d") + " -> " + dataMap.get("salary_d").toString() + " -> " + NumberUtils.isParsable(dataMap.get("salary_d").toString()));
        // 1988876565677.99889 -> 1988876565677.99889 -> true
        System.out.println(dataMap.get("salary_s") + " -> " + dataMap.get("salary_s").toString() + " -> " + NumberUtils.isParsable(dataMap.get("salary_s").toString()));
    }
